...
public abstract class BaseAbsencePeerImpl
    extends org.apache.torque.util.BasePeerImpl<Absence>
{
    /** The class log. */
    private static Log log = LogFactory.getLog(BaseAbsencePeerImpl.class);

    /** Serial version */
    private static final long serialVersionUID = 1390232693221L;
     ...
     * initialized.
     */
    public BaseAbsencePeerImpl()
    {
        this(new AbsenceRecordMapper(),
            AbsencePeer.TABLE,
            AbsencePeer.DATABASE_NAME);
    }
     ...
     */
    public BaseAbsencePeerImpl(
            RecordMapper<Absence> recordMapper, 
            TableMap tableMap,
            String databaseName)
    {
     ...
     */
    public List<Absence> doSelect(Absence obj)
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public Absence doSelectSingleRecord(
                Absence obj)
            throws TorqueException
    {
        List<Absence> absenceList = doSelect(obj);
     ...
     */
    public Absence getDbObjectInstance()
    {
        return new Absence();
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public void doInsert(Absence obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public void doInsert(Absence obj, Connection con)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        Criteria selectCriteria 
                = new Criteria(AbsencePeer.DATABASE_NAME);
        correctBooleans(columnValues);

        selectCriteria.where(
                AbsencePeer.ABSENCE_ID,
                columnValues.remove(AbsencePeer.ABSENCE_ID).getValue());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doUpdate(Absence obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doUpdate(Absence obj, Connection con)
        throws TorqueException
    {
        ColumnValues columnValues = buildColumnValues(obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Absence obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Absence obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Collection<Absence> objects)
            throws TorqueException
    {
        int result = doDelete(buildPkCriteria(objects));
        for (Absence object : objects)
        {
    ...
    public Criteria buildCriteria(ObjectKey pk)
    {
        ...
        criteria.and(AbsencePeer.ABSENCE_ID, pk);
        return criteria;
     }
    ...
    {
        Criteria criteria = new Criteria();
        criteria.andIn(AbsencePeer.ABSENCE_ID, pks);
        return criteria;
     }
     ...
     */
    public Criteria buildCriteria(Absence obj)
    {
        Criteria criteria = new Criteria(AbsencePeer.DATABASE_NAME);
        if (!obj.isNew())
        {
            criteria.and(AbsencePeer.ABSENCE_ID, obj.getAbsenceId());
        }
        criteria.and(AbsencePeer.ETUDIANT_ID, obj.getEtudiantId());
        criteria.and(AbsencePeer.DATE, obj.getDate());
        criteria.and(AbsencePeer.JUSTIFIE, obj.getJustifie());
        return criteria;
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public Criteria buildSelectCriteria(Absence obj)
    {
        Criteria criteria = new Criteria(AbsencePeer.DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     *         (should not happen).
     */
    public ColumnValues buildColumnValues(Absence absence)
            throws TorqueException
    {
        ColumnValues columnValues = new ColumnValues();
        if (!absence.isNew() 
            || absence.getAbsenceId() != 0)
        {
            columnValues.put(
                    AbsencePeer.ABSENCE_ID,
                    new JdbcTypedValue(
        ...
        columnValues.put(
                ...
                new JdbcTypedValue(
                    absence.getEtudiantId(),
                    4));
        java.util.Date date = absence.getDate();
        if (date != null)
        {
        ...
        String justifie = Boolean.TRUE.equals(absence.getJustifie())
                                    ? "Y"
                                    : "N";
        columnValues.put(
                AbsencePeer.JUSTIFIE,
                new JdbcTypedValue(justifie, Types.CHAR));
        return columnValues;
    }
     ...
     */
    public Absence retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public Absence retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public Absence retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection connection = null;
        try
        {
            connection = Transaction.begin(AbsencePeer.DATABASE_NAME);
            Absence result = retrieveByPK(pk, connection);
            Transaction.commit(connection);
            connection = null;
            return result;
        }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public Absence retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Absence> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Absence> retrieveByPKs(Collection<ObjectKey> pks)
        throws TorqueException
    {
        Connection connection = null;
        try
        {
            connection = Transaction.begin(AbsencePeer.DATABASE_NAME);
            List<Absence> result = retrieveByPKs(pks, connection);
            Transaction.commit(connection);
            connection = null;
            return result;
        }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Absence> retrieveByPKs(
            ...
            throws TorqueException
    {
        ...
        List<Absence> result = doSelect(criteria, dbcon);
        return result;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Absence> doSelectJoinEtudiant(Criteria criteria)
        throws TorqueException
    {
        Connection connection = null;
        try
        {
            connection = Transaction.begin(
                    AbsencePeer.DATABASE_NAME);
            List<Absence> result
                    = AbsencePeer.doSelectJoinEtudiant(criteria, connection);
            Transaction.commit(connection);
            connection = null;
            return result;
        }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Absence> doSelectJoinEtudiant(
        ...
        throws TorqueException
    {
        ...
        fr.iut2.sil4.data.EtudiantPeer.addSelectColumns(criteria);

        CompositeMapper compositeMapper = new CompositeMapper();
        compositeMapper.addMapper(
                new AbsenceRecordMapper(),
                0);
        compositeMapper.addMapper(
                new EtudiantRecordMapper(),
                AbsencePeer.numColumns);
        criteria.addJoin(AbsencePeer.ETUDIANT_ID,
            fr.iut2.sil4.data.EtudiantPeer.ETUDIANT_ID);
        ...
        {
            Absence obj1 = (Absence) rawResultRow.get(0);
            Etudiant obj2 = (Etudiant) rawResultRow.get(1);

            boolean newObject = true;
            for (int j = 0; j < result.size(); j++)
            {
                Absence temp_obj1 = result.get(j);
                fr.iut2.sil4.data.Etudiant temp_obj2 = temp_obj1.getEtudiant();
