    ...
    extends org.apache.torque.util.BasePeerImpl<Note>
{
    ...
    /** Serial version */
    private static final long serialVersionUID = 1390232693192L;
    ...
    public Criteria buildCriteria(Note obj)
    {
        ...
        criteria.and(NotePeer.ETUDIANT_ID, obj.getEtudiantId());
        criteria.and(NotePeer.MATIERE_ID, obj.getMatiereId());
        criteria.and(NotePeer.VALEUR, obj.getValeur());
        return criteria;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Note> doSelectJoinEtudiant(Criteria criteria)
        throws TorqueException
    {
        Connection connection = null;
        try
        {
            connection = Transaction.begin(
                    NotePeer.DATABASE_NAME);
            List<Note> result
                    = NotePeer.doSelectJoinEtudiant(criteria, connection);
            Transaction.commit(connection);
            connection = null;
            return result;
        }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Note> doSelectJoinEtudiant(
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Note> doSelectJoinMatiere(Criteria criteria)
        throws TorqueException
    {
        Connection connection = null;
        try
        {
            connection = Transaction.begin(
                    NotePeer.DATABASE_NAME);
            List<Note> result
                    = NotePeer.doSelectJoinMatiere(criteria, connection);
            Transaction.commit(connection);
            connection = null;
            return result;
        }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Note> doSelectJoinMatiere(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        setDbName(criteria);
