...
/**
 * Maps ResultSet rows into MatiereClasse objects.
 *
 ...
 *
 */
public class BaseMatiereClasseRecordMapper implements RecordMapper<MatiereClasse>
{

    /** The class log. */
    private static Log log
            = LogFactory.getLog(BaseMatiereClasseRecordMapper.class);
     ...
     *         than the columns in the matiere_classe table.
     */
    public MatiereClasse processRow(
                ResultSet resultSet,
                int offset,
            ...
            throws TorqueException
    {
        ...
        try 
        {
            matiereClasse.setLoading(true);
            if (criteria == null)
            {
                matiereClasse.setMatiereClasseId(
                        getMatiereClasseId(resultSet, offset + 1));
                matiereClasse.setClasseId(
                        getClasseId(resultSet, offset + 2));
                matiereClasse.setMatiereId(
                        getMatiereId(resultSet, offset + 3));
            }
            else
            {
                ...
                {
                    if (BaseMatiereClassePeer.MATIERE_CLASSE_ID.getSqlExpression().equals(
                            column.getSqlExpression()))
                    {
                        matiereClasse.setMatiereClasseId(
                            getMatiereClasseId(resultSet, totalOffset));
                        columnMapped = true;
                    }
                    else if (BaseMatiereClassePeer.CLASSE_ID.getSqlExpression().equals(
                            column.getSqlExpression()))
                    {
                        matiereClasse.setClasseId(
                    ...
                    else if (BaseMatiereClassePeer.MATIERE_ID.getSqlExpression().equals(
                            column.getSqlExpression()))
                    {
                        matiereClasse.setMatiereId(
            ...
            matiereClasse.setNew(false);
            matiereClasse.setModified(false);
        }
        finally
        {
            matiereClasse.setLoading(false);
        }
         ...
         * the field matiereClasseId in MatiereClasse.
         *
         ...
         *         from the resultSet.
         */
        protected int getMatiereClasseId(
                    ResultSet resultSet,
                    int columnIndex)
                throws TorqueException
        {
         ...
         * Reads the value of the <code>columnIndex</code>'th column
         * in the <code>resultSet</code> so that it can be used to set
         * the field classeId in MatiereClasse.
         *
         * @param dbObject the database object to fill, not null.
         * @param resultSet the ResultSet to read from, not null.
         * @param columnIndex the index in the resultSet which should be read.
         ...
         * Reads the value of the <code>columnIndex</code>'th column
         * in the <code>resultSet</code> so that it can be used to set
         * the field matiereId in MatiereClasse.
         *
         * @param dbObject the database object to fill, not null.
         * @param resultSet the ResultSet to read from, not null.
         * @param columnIndex the index in the resultSet which should be read.
