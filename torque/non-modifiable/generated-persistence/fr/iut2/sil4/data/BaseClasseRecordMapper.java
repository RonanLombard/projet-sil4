 ...
 *
 */
public class BaseClasseRecordMapper implements RecordMapper<Classe>
{

    /** The class log. */
    private static Log log
            = LogFactory.getLog(BaseClasseRecordMapper.class);
     ...
     *         than the columns in the classe table.
     */
    public Classe processRow(
                ResultSet resultSet,
                int offset,
            ...
            throws TorqueException
    {
        ...
        try 
        {
            ...
            {
                classe.setClasseId(
                        getClasseId(resultSet, offset + 1));
                classe.setNom(
            ...
            else
            {
                ...
                {
                    if (BaseClassePeer.CLASSE_ID.getSqlExpression().equals(
                    ...
                    else if (BaseClassePeer.NOM.getSqlExpression().equals(
                            column.getSqlExpression()))
                    {
                        classe.setNom(
