...
public abstract class BaseNotePeer
{
    ...
    /** The column for the valeur field */
    public static final ColumnMap VALEUR;
    ...
    static
    {
        ...
        TABLE.setDescription("Table des notes");
    ...
    // ------------- Column: note_id --------------------
        ...
        NOTE_ID.setDescription("ID note");
    ...
    // ------------- Column: valeur --------------------
        VALEUR = new ColumnMap("valeur", TABLE);
        VALEUR.setType(Integer.valueOf(0));
        VALEUR.setTorqueType("INTEGER");
        VALEUR.setUsePrimitive(true);
        VALEUR.setPrimaryKey(false);
        VALEUR.setNotNull(true);
        VALEUR.setJavaName("Valeur");
        VALEUR.setAutoIncrement(true);
        VALEUR.setProtected(false);
        VALEUR.setJavaType( "int" );
        VALEUR.setDescription("Valeur de la note");
        VALEUR.setPosition(4);
    ...
    *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Note> doSelectJoinEtudiant(Criteria criteria)
        throws TorqueException
    {
        return getNotePeerImpl().doSelectJoinEtudiant(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Note> doSelectJoinEtudiant(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getNotePeerImpl().doSelectJoinEtudiant(criteria, conn);
    }
    /**
     * Selects a collection of dbObjectClassName objects pre-filled with their
     * Matiere objects.
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Note> doSelectJoinMatiere(Criteria criteria)
        throws TorqueException
    {
        return getNotePeerImpl().doSelectJoinMatiere(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Note> doSelectJoinMatiere(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getNotePeerImpl().doSelectJoinMatiere(criteria, conn);
    }
