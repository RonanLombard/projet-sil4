        ...
        try 
        {
            ...
            else
            {
                ...
                for (Column column : columnsWithoutOffset)
                {
                    ...
                    else if (BaseNotePeer.ETUDIANT_ID.getSqlExpression().equals(
                            column.getSqlExpression()))
                    {
                        note.setEtudiantId(
                    ...
                    else if (BaseNotePeer.MATIERE_ID.getSqlExpression().equals(
                            column.getSqlExpression()))
                    {
                        note.setMatiereId(
                    ...
                    else if (BaseNotePeer.VALEUR.getSqlExpression().equals(
                            column.getSqlExpression()))
                    {
                        note.setValeur(
                            getValeur(resultSet, totalOffset));
                        columnMapped = true;
                    }
                    totalOffset++;
                }
