...
public abstract class BaseClassePeerImpl
    extends org.apache.torque.util.BasePeerImpl<Classe>
{
    /** The class log. */
    private static Log log = LogFactory.getLog(BaseClassePeerImpl.class);

    /** Serial version */
    private static final long serialVersionUID = 1390232693149L;
     ...
     * initialized.
     */
    public BaseClassePeerImpl()
    {
        this(new ClasseRecordMapper(),
            ClassePeer.TABLE,
            ClassePeer.DATABASE_NAME);
    }
     ...
     */
    public BaseClassePeerImpl(
            RecordMapper<Classe> recordMapper, 
            TableMap tableMap,
            String databaseName)
    {
     ...
     */
    public List<Classe> doSelect(Classe obj)
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public Classe doSelectSingleRecord(
                Classe obj)
            throws TorqueException
    {
        List<Classe> classeList = doSelect(obj);
        Classe classe = null;
        if (classeList.size() > 1)
        {
     ...
     */
    public Classe getDbObjectInstance()
    {
        return new Classe();
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public void doInsert(Classe obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public void doInsert(Classe obj, Connection con)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        Criteria selectCriteria 
                = new Criteria(ClassePeer.DATABASE_NAME);
        correctBooleans(columnValues);

        selectCriteria.where(
                ClassePeer.CLASSE_ID,
                columnValues.remove(ClassePeer.CLASSE_ID).getValue());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doUpdate(Classe obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doUpdate(Classe obj, Connection con)
        throws TorqueException
    {
        ColumnValues columnValues = buildColumnValues(obj);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Classe obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Classe obj, Connection con)
        throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doDelete(Collection<Classe> objects)
            throws TorqueException
    {
        int result = doDelete(buildPkCriteria(objects));
        for (Classe object : objects)
        {
    ...
    public Criteria buildCriteria(ObjectKey pk)
    {
        ...
        criteria.and(ClassePeer.CLASSE_ID, pk);
        return criteria;
     }
    ...
    {
        Criteria criteria = new Criteria();
        criteria.andIn(ClassePeer.CLASSE_ID, pks);
        return criteria;
     }
     ...
     */
    public Criteria buildCriteria(Classe obj)
    {
        Criteria criteria = new Criteria(ClassePeer.DATABASE_NAME);
        if (!obj.isNew())
        {
            criteria.and(ClassePeer.CLASSE_ID, obj.getClasseId());
        }
        criteria.and(ClassePeer.NOM, obj.getNom());
        return criteria;
    }
     ...
     * @param obj the object to build the criteria from, not null.
     */
    public Criteria buildSelectCriteria(Classe obj)
    {
        Criteria criteria = new Criteria(ClassePeer.DATABASE_NAME);
        if (!obj.isNew())
        {
     ...
     *         (should not happen).
     */
    public ColumnValues buildColumnValues(Classe classe)
            throws TorqueException
    {
        ColumnValues columnValues = new ColumnValues();
        if (!classe.isNew() 
            || classe.getClasseId() != 0)
        {
            columnValues.put(
                    ClassePeer.CLASSE_ID,
                    new JdbcTypedValue(
     ...
     */
    public Classe retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public Classe retrieveByPK(int pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public Classe retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection connection = null;
        try
        {
            connection = Transaction.begin(ClassePeer.DATABASE_NAME);
            Classe result = retrieveByPK(pk, connection);
            Transaction.commit(connection);
            connection = null;
            return result;
        }
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public Classe retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Criteria criteria = buildCriteria(pk);
        List<Classe> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Classe> retrieveByPKs(Collection<ObjectKey> pks)
        throws TorqueException
    {
        Connection connection = null;
        try
        {
            connection = Transaction.begin(ClassePeer.DATABASE_NAME);
            List<Classe> result = retrieveByPKs(pks, connection);
            Transaction.commit(connection);
            connection = null;
            return result;
        }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Classe> retrieveByPKs(
            ...
            throws TorqueException
    {
        ...
        List<Classe> result = doSelect(criteria, dbcon);
        return result;
    }
        ...
        throws TorqueException
    {
        ...
        try
        {
            connection = Transaction.begin(
                    ClassePeer.DATABASE_NAME);
            setAndSaveEtudiants(toLinkTo, toSave, connection);
            Transaction.commit(connection);
            connection = null;
        }
        finally
        ...
        throws TorqueException
    {
        ...
        for (Etudiant toSaveElement : toSave)
        {
        ...
        criteria.and(EtudiantPeer.ETUDIANT_ID, toSaveKeys, Criteria.IN);
        List<Etudiant> intersection
                = EtudiantPeer.doSelect(criteria, connection);
        List<Etudiant> linkedCache;
        if (toLinkTo.isEtudiantsInitialized()) {
            linkedCache = toLinkTo.getEtudiants();
            linkedCache.clear();
        }
        else
        {
            linkedCache = toLinkTo.initEtudiants();
        }
        for (Etudiant toSaveElement : toSave)
        {
            ...
            if (listIndex == -1)
            {
                toLinkTo.addEtudiant(toSaveElement);
        ...
        deleteCriteria.and(EtudiantPeer.ETUDIANT_ID, toSaveKeys, Criteria.NOT_IN);
        EtudiantPeer.doDelete(deleteCriteria, connection);
    }
    /** 
     * Saves the passed collection as linked objects.
     * This means the following is done:
